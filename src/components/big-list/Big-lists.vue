    ...
    <div class="w-full flex-auto px-0 pt-0 pb-2">
      <DataTable
        ...
        <Column v-for="item in header"
          ...
          <template #header>
            <div class="-mx-0.5 border-b border-collapse border-b-solid font-bold text-left uppercase align-middle bg-transparent shadow-none dark:border-white/40 dark:text-white text-xxs  tracking-none whitespace-nowrap text-slate-400 opacity-70">
              <span>{{ item.name }}</span>
            </div>
          </template>
